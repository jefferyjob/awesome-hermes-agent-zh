...
> 翻译自 [awesome-hermes-agent](https://github.com/0xNyk/awesome-hermes-agent) 库，本仓库持续同步更新。
> 
...
本列表采用 [MIT License](LICENSE) 许可。你可以自由使用、复制、修改、合并、发布、分发、再许可和销售本材料的副本，但须保留原始版权声明和许可声明。
